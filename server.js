...
// Служебный эндпоинт для Railway health checks
...
// Игровое состояние (в реальном приложении используйте базу данных)
let gameState = {
    state: 'waiting',
    multiplier: 1.00,
    startTime: null,
...
// Используем PORT из environment variables или 3000
